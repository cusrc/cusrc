                ...
                function(D) {
                    if (D.code == 0) {
                        ...
                        if (v.isCount == 1) {
                            x = D.count;
                            v.isCount = 0;
                            B = '<li class="m-userMoneylst-tt"><span>时间</span><span>数量</span><span>备注</span></li>'
                        }
                        var C = D.listItems;
                        var A = C.length;
                        for (var z = 0; z < A; z++) {
                            C[z].money =  C[z].money -0 ;
                            C[z].type =  C[z].type -0 ;
                            C[z].money =  C[z].money *  C[z].type  ;

                           // C[z].time  =        DateFormat(C[z].time );
                ...
                function(D) {
                    if (D.code == 0) {
                        ...
                        if (v.isCount == 1) {
                            v.isCount = 0;
                            x = D.count;
                            B = '<li class="m-userMoneylst-tt"><span>时间</span><span>金币</span></li>';
                            // B = '<li class="m-userMoneylst-tt"><span>时间</span><span>金币</span><span>备注</span></li>';
