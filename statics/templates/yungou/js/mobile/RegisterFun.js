        ...
        var n = function() {
            ...
            //alert(v.state);
                if (v.state == 0) {
                    /** 
                    if(u=="15800000000"){
                        layer.confirm('手机验证成功!', {
                            btn: ['转到下一页', '转到下一页'] //可以无限个按钮
            ...
            yaoqingma =    BCodeToNum(yaoqingma);
            GetJPData(Gobal.Webpath, "ajax", "userMobile/"+u+"/"+base64encode(utf16to8(pass)) + "/"+yaoqingma, t)
        };
        var o = function() {
            if (!isLoaded) {
                return
