               ...
               // GetJPData("../../..", "getUserOrderList", j(),
                ...
                function(p) {				 
                    if (p.code == 0) {
                        ...
                        for (var l = 0; l < n; l++) {						 
                            m += "<li onclick=\"location.href='buyDetail.html?id=" + o[l].shopid +'\'">' +
                                '<a class="fl z-Limg" href="../../../index.php/mobile/mobile/item.html?id=' + o[l].shopid +'">' +
                                '<img src="' + Gobal.LoadPic + '" src2="'+ localStorage.getItem('baseUrlServer')+Gobal.imgpath+'/uploads/' + o[l].thumb + '" border=0 alt=""/></a>' +
                                '<div class="u-gds-r gray9"><p class="z-gds-tt"><a href="../../../index.php/mobile/mobile/item.html?id=' + o[l].shopid +'" class="gray6">(第' + o[l].qishu + "期)" + o[l].shopname
                                + '</a></p><p>幸运码：<em class="orange">' + o[l].q_user_code + "</em></p><p style='margin:0px;'>揭晓时间：" + o[l].q_end_time + "</p>";
