                ...
                var y = function(I) {
                    if (I.code == 0) {
                        ...
                        for (var D = 0; D < C; D++) {
                            ...
                            var z = Math.ceil(G);
                            // onclick=\"location.href='"+Gobal.Webpath+
                            // "/mobile/mobile/item/" + F.shopid + '\'"
                            //E123456 链接不对
                            E += '<ul ><li class="mBuyRecordL">';
                            E += '<img src2="' + localStorage.getItem('baseUrlServer')+Gobal.imgpath+'/uploads/' + F.thumb
                                + '" src="'  + localStorage.getItem('baseUrlServer')
                                + Gobal.LoadPic + '"></li>';
                            ...
                            if (F.codeState == 3) {
                                ...
                                //     +Gobal.Webpath+'/mobile/mobile/userindex/' + F.q_uid + '"

                                E += '<p class="mValue">价值：￥' + F.money + '</p><span>获得者：<a style="color: #22AAff" >' + F.q_user
                                    + '</a><br>幸运码：<em class="orange">' + F.q_user_code + "</em></span>"
                            } else {
            ...
            var v = function() {
                var y = function(z) {
                    ...
                    if (z.code == 0) {
                        ...
                        for (var A = 0; A < E; A++) {
                            var C = D[A];
                            // onclick=\"location.href='"+  Gobal.Webpath+"/mobile/mobile/item/" + C.id
                            // + '\'"
                            //E123456 链接不对
                            B +='<ul class="BuyRecordList"><li class="mBuyRecordL">';
                            B += '<img src2="' + localStorage.getItem('baseUrlServer')+Gobal.imgpath+'/uploads/'
                                + C.thumb + '" src="' + Gobal.LoadPic + '"></li>';
                ...
                var y = function(H) {				 
                    if (H.code == 0) {
                        ...
                        for (var E = 0; E < D; E++) {
                            ...
                            //'+Gobal.Webpath+'
                            F += '<li><a href="../home/buyDetail.html?id=' + G.sd_id + '"><h3><b>' + G.sd_title + "</b><em>" + G.sd_time + "</em></h3>";
                            F += "<p>" + z + "</p><dl>";
                            var A = G.sd_thumbs.split(",");
                            for (var C = 0; C < A.length; C++) {
                                F += '<img src2="' + localStorage.getItem('baseUrlServer')
                                    +Gobal.imgpath+'/uploads/' + A[C] + '" src="' + Gobal.LoadPic + '">';
                                if (C >= 2) {
                                    break
                                }
                            }
