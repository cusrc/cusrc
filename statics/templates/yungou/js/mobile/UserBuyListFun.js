            ...
            function(q) {
                if (q.code == 0) {
                    ...
                    for (var p = 0; p < r; p++) {
                        ...
                        //"+Gobal.Webpath+"
                        o += "<li onclick=\"location.href='buyDetail.html?id=" + n[p].shopid + '\'"><a class="fl z-Limg">';
                        if (m == 1) {
                        ...
                        o += '<img src="' + Gobal.LoadPic + '" src2="'+Gobal.imgpath+'/uploads/' + n[p].thumb + '" border=0 alt=""></a>' +
                            '<div class="u-sgl-r "><p class="z-sgl-tt"><a class="gray6">(第' + n[p].shopqishu + "期)" + n[p].shopname + "</a></p>";
                        if (m == 1 || m == 2) {
                            ...
                            u = s > 0 && u < 1 ? 1 : u;
                            o += '<p>已参与<em class="orange">' + n[p].gonumber + '</em>人次</p><div class="Progress-bar"><p class="u-progress">'
                                + (s > 0 ? '<span style="width:' + u + '%;" class="pgbar"><span class="pging"></span></span>': "")
                                + '</p><ul class="Pro-bar-li"><li class="P-bar01"><em>' + s + '</em>已参与</li><li class="P-bar02"><em>'
                                + t + '</em>总需人次</li><li class="P-bar03"><em>' + l + "</em>剩余</li></ul></div>"
                        } else {
                            if (m == 3) {
                               if(n[p].q_end_times<=timestamp){
