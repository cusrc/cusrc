$(function() {
    var a = function() {
                ...
                var m = function(r) {
                    ...
                    for (var o = r.length - 1; o > -1; o--) {
                        ...
                        if (g.indexOf("," + p.codeID + ",") < 0) {
                            ...
                            s.click(function() {
                                location.href =  "../mobile/item.html?id="+ $(this).attr("id")
                            });
                            q.prepend(s);
        ...
        $("li", c).each(function() {
            ...
            var l = m.attr("codeid");
            m.click(function() {
                location.href =  "../mobile/item.html?id=" + l
            });
            var n = m.attr("uweb");
            if (n != undefined) {
        ...
        $("#ulRecommend > li").each(function() {
            var l = $(this);
            l.click(function() {
                location.href =  "../mobile/item.html?id=" + l.attr("id")
            })
        })
    };
    a();
	(function(){
		...
		var update = function(info){
			...
			html += '		<a href="../mobile/item.html?id='+info.id+'">';
