...
jwebox.goshopnow = function(shopid,path){
				...
				*{margin:0;padding:0;list-style-type:none;}
				...
				<div class="jwebox_showbox">			
					<div class="jwebox_background"></div>
						...
						<h1 class="jwebox_locked"  onselectstart="return false;">快捷支付——您将要宝藏世界的商品信息<a class="span" href="javascript:void(0);">×</a></h1>
							...
							<div class="jwebox_mainlist"><span class="jwebox_mainlist_uspecies">您的账户金币：<span class="jwebox_uspecies" ></span>宝藏币</span></div>
							<div class="jwebox_shop_buttom" >
								<a href="javascript:;"  class="jwebox_Det_Shopnow"  id="jwebox_Det_Shopnow">立即支付</a>
								<a href="index.php/member/home/userrecharge.html"  class="jwebox_Det_Shopnow">去充值</a>
							</div>
		...
		if(shopnum>3000){
			$(".jwebox_shop_relog").text('宝藏世界人次大于3000会产生多条购买记录！');
			setTimeout(function(){
...
$(".jwebox_Det_Shopnow_add").click(function(){
		window.open(path+"/member/home/userrecharge.html/","_blank");
	});
