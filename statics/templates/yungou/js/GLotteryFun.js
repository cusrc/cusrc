				...
				function gg_show_time_add_li(div,path,info){	
					...
					html+='<li class="countdown_li">';
						html+='<a href="../mobile/item.html?url=dataserver&id='+info.id+'" target="_blank" class="pic">';
							html+='<img src="'+info.upload+'/'+info.thumb+'">';
						html+='</a>';
					html+='<a href="../mobile/item.html?url=dataserver&id='+info.id+'" target="_blank" class="name">'+info.title+'</a>';
					...
					var uhtml = '';
						uhtml += '<a href="../mobile/item.html?url=dataserver&id='+info.id+'" target="_blank" class="pic">';
							uhtml +='<img src="'+info.upload+'/'+info.thumb+'">';
						uhtml +='</a>';
						uhtml+='<a href="../mobile/item.html?url=dataserver&id='+info.id+'" target="_blank" class="name">'+info.title+'</a>';
